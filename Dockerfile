...
COPY ./STM32MPU-Ecosystem-v4.0.0 ./STM32MPU_Ecosystem-v4.0.0
...
RUN apt-get install -y zstd gawk wget git diffstat unzip texinfo gcc build-essential chrpath socat cpio python3 python3-pip python3-pexpect xz-utils debianutils iputils-ping python3-git python3-jinja2 libegl1-mesa libsdl1.2-dev xterm python3-subunit mesa-common-dev liblz4-tool
...
RUN apt-get install -y libpcre3-dev libffi-dev libgdk-pixbuf-2.0-0
